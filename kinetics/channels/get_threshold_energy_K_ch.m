function [threshold_energy_j, threshold_j] = get_threshold_energy_K_ch(o3_molecule, o2_molecule, K, K_vib_sym_well, ...
  optional)
% Returns threshold energy for a given molecule, channel and K
  ...
  threshold_j = get_o2_threshold_j(o2_molecule, K, K_vib_sym_well, ...
