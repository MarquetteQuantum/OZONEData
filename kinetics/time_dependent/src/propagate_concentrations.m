function [concentrations_per_m3, derivatives_per_m3_s] = propagate_concentrations(...
  o3_molecule, states, initial_concentrations_per_m3, equilibrium_constants_m3, time_s, sigma0_m2, temp_k, ...
  m_conc_per_m3, dE_j, transition_model, optional)
...
% Level specifies level of theory
  ...
  if o3_molecule == "666"
    ode_func = @(t, y) do3dt_666(transition_matrix_mod_m3_per_s, decay_rates_per_s, equilibrium_constants_m3, ...
      m_conc_per_m3, y);
  else
