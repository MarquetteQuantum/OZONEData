function res = do3dt_level_2_light(transition_matrix_m3_per_s, decay_rates_per_s, ...
...
% Total concentrations of O and O2 are stored in the last 2 elements of state_concs
  ...
  transition_influx_total_per_m3_s = transition_matrix_m3_per_s' * state_concs_per_m3(1 : end - 2) * ...
    m_conc_per_m3;
  transition_outflux_per_m3_s = sum(transition_matrix_m3_per_s, 2) .* state_concs_per_m3(1 : end - 2) * ...
    m_conc_per_m3;
  ...
  derivatives_per_m3_s(1 : end - 2) = transition_influx_total_per_m3_s - transition_outflux_per_m3_s ...
    + formation_per_m3_s - decay_per_m3_s;
