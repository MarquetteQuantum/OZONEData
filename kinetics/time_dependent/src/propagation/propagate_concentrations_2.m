function krecs_m6_per_s = propagate_concentrations_2(o3_molecule, states, initial_concentrations_per_m3, time_s, ...
  sigma0_m2, temp_k, M_conc_per_m3, dE_j, region_names, optional)
...
% region_names specifies names of the columns in states table to be used as sym/asym separation multipliers
  ...
  krecs_m6_per_s = propagate_concentrations(o3_molecule, states, ...
    initial_concentrations_per_m3, equilibrium_constants_m3, decay_coeffs_per_s, time_s, sigma0_m2, ...
    temp_k, M_conc_per_m3, dE_j, region_names, separate_concentrations=optional.separate_concentrations, ...
    transition_model=optional.transition_model);
end