function plot_delta_676_vs_pressure_experimental_2()
...
% Does not create new plot
  ...
  plot(data_morton(:, 1), data_morton(:, 2), 'ro', MarkerSize=10);
  plot(data_thiemens_1988(:, 1), data_thiemens_1988(:, 2), 'rsquare', MarkerSize=10);
  plot(data_thiemens_1990(:, 1), data_thiemens_1990(:, 2), 'rdiamond', MarkerSize=10);
end