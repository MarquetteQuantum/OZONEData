function [ref_energy_j, lowest_threshold_energy_j] = get_higher_barrier_threshold(barriers_prefix, o3_molecule, J, K, vib_sym_well)
% Returns max of lowest threshold energy (K-dependent) and lowest barrier energy
