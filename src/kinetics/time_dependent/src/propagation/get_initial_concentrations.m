function initial_concentrations_per_m3 = get_initial_concentrations(ch1_concs_per_m3, o3_molecule, states, temp_k, ...
  optional)
...
% Assumes 2nd channel is in equilibrium with first
  ...
  assert(implies(optional.separate_concentrations, ~isempty(optional.region_names)), ...
    "region_names has to be provided if separate_concentrations is true");
