function run_propagation_job()
  ...
  remote_folder = "/mmfs1/home/3830gaydayi/kinetic_runs/666/separate/pend/no_vdw/test";
  num_cores = 512;
  ...
  c.AdditionalProperties.AdditionalSubmitArgs = "-J 666/separate/pend/no_vdw/test -N 8";
